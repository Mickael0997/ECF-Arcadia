...
<main>
    <a class="activity_button" href="add_activity.php">Ajouter une nouvelle activité</a>
        ...
        <tbody>
            <?php foreach ($activites as $activite): ?>
                <tr class="admin_tableau">
                    ...
                    <td><img src="<?php echo htmlspecialchars($activite['image_activite']); ?>" alt="Image de l'activité" style="width: 100px; height: auto;"></td>
                    <td>
                        <a href="edit_activity.php?id=<?php echo $activite['id_activite']; ?>" class="edit-link" data-id="<?php echo $activite['id_activite']; ?>">Modifier</a>
                        <a href="delete_activity.php" class="delete-link" data-id="<?php echo $activite['id_activite']; ?>">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmAction.addEventListener('click', function() {
            if (actionType === 'delete') {
                window.location.href = `delete_activity.php?id=${actionId}`;
            } else if (actionType === 'edit') {
                window.location.href = `edit_activity.php?id=${actionId}`;
            }
        });
