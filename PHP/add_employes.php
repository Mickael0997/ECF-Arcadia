...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO employe (nom, prenom, fonction, adresse_mail, mot_de_passe, telephone) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->execute([$nom, $prenom, $fonction, $adresse_mail, $mot_de_passe, $telephone]);
...
<main>
    <form method="POST" action="add_employes.php" class="add-employe">
